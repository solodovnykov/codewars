...
describe("SQL tests", function () {
  ...
  it("Basic SELECT and WHERE over objects", function () {
    ...
    Test.assertSimilar(query().select(profession).from(persons).execute(), [
      "teacher",
      "teacher",
      "teacher",
      "scientific",
  ...
  it("Numbers tests", function () {
    ...
    Test.assertSimilar(parityResult, [["odd", [1, 3, 5, 7, 9]]]);
